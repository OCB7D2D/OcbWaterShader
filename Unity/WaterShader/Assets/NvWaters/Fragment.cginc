...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #endif
    albedo = lerp(albedo, albedo2, _Albedo2Strength);
#endif
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #endif
    albedo = lerp(albedo, albedo1, _Albedo1Strength);
#endif
...
float sampleDist = 0.5; // / pow(abs(camDist), 0.5) * 100;

float noiseY = WavesNoise2(IN.worldPos.xz, float2(0, 0));
float noiseX = WavesNoise2(IN.worldPos.xz, float2(-sampleDist, 0));
float noiseZ = WavesNoise2(IN.worldPos.xz, float2(0, -sampleDist));

float3 vy = IN.worldPos.xyz;
float3 vx = IN.worldPos.xyz;
float3 vz = IN.worldPos.xyz;
...
if (noiseY == noiseX && noiseX == noiseZ) {
    o.Normal.r = 0.5;
}
    ...
    float3 normal1 = UnpackNormalScaled(tex2D(_NormalMap1, UVN1), _NormalMap1Strength);
        ...
        normd1.xyz = UnpackNormalScaled(normd1, _NormalMap1Strength * dblend1);
    ...
    float3 normal2 = UnpackNormalScaled(tex2D(_NormalMap2, UVN2), _NormalMap2Strength);
        ...
        normd2.xyz = UnpackNormalScaled(normd2, _NormalMap2Strength * dblend2);
