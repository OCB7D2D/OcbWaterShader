...
Shader "OcbWaterDistantHigh" {
    ...
    Properties {
        ...
        // #ifdef EFFECT_WAVES
        //----------------------------------------------
        _WavesNoise("Water Wave Noise Texture", 2D) = "gray" {}
        _WavesNormal("Water Wave Normal Texture", 2D) = "bump" {}
        ...
        _RenormStepDelta("Step Delta for Renormalization", Range(0, 10)) = 0.1
